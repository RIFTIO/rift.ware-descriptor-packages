...
# From https://open.riftio.com/documentation/riftware/4.3/a/develop/vnf-develop/launchpad-package-folder-structure.htm
...
vnfd:vnfd-catalog:
    ...
    -   vnfd:id: ${name}
        ...
        vnfd:description: Generated by RIFT.io pacakage generator
        vnfd:vendor: ${VENDOR}
        vnfd:version: '1.0'
...
nsd:nsd-catalog:
    ...
    -   nsd:id: ${name}
        nsd:name: ${name}
        nsd:short-name: ${name}
        nsd:description: Generated by RIFT.io pacakage generator
        nsd:vendor: ${VENDOR}
        nsd:version: '1.0'
