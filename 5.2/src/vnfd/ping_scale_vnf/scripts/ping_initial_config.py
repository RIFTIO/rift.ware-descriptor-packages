...
def ping_initial_config(yaml_cfg, logger):
    ...
    def set_ping_destination(mgmt_ip, port, pong_ip, pong_port):
        ...
        while True:
            ...
            if proc.returncode == 0:
                ...
                rc = proc.returncode
                logger.error(" Executing cmd {}  returned code {} ".format(curl_cmd, rc))
                break
    ...
    pong_svc_ip = find_cp_ip(pong_vnfr, 'pong_vnfd/cp1')
    ...
    while True:
        ...
        if proc.returncode == 0:
            ...
            rc = proc.returncode
            logger.error(" Executing cmd {}  returned code {} ".format(cmd, rc))
            break
